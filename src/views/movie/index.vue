      ...
      <div class="aircle">
        ...
        <div class="swiper-container screening">
          ...
          <div class="swiper-wrapper slide-content">
            <div class="swiper-slide slide-content-item">
              <a href="#" class="hoting-movie-img"
                ><img
                  src="../../assets/images/movie/index/p2623955494.webp"
                  alt=""
              /></a>
              <div class="movie-title">
                <a href="#"
                  >数码宝贝：最后的进化 デジモンアドベンチャー LAST EVOLUTION
                  絆</a
                >
              </div>
              <div class="grade">
